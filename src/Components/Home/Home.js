            ...
            <div className="hero min-h-screen" style={{ backgroundImage: `url("https://github.com/sajiburrahmansajib/img/blob/main/learning/bg.jpg?raw=true")` }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        ...
                        <p className="mb-5 indent-3"> The aim of frameworks is to provide a common structure so that developers don’t have to redo it from scratch and can reuse the code provided. In this way, frameworks allow us to cut out much of the work and save a lot of time.Its the time to learn web framework </p>
